...
whose {return new Symbol(sym.quién, yychar, yyline,yytext());}
...
have {return new Symbol(sym.tengo, yychar, yyline,yytext());}
...
ceiling {return new Symbol(sym.techo, yychar, yyline,yytext());}
...
the {return new Symbol(sym.el, yychar, yyline,yytext());}
the {return new Symbol(sym.la, yychar, yyline,yytext());}
the {return new Symbol(sym.los, yychar, yyline,yytext());}
the {return new Symbol(sym.las, yychar, yyline,yytext());}
...
bookstore {return new Symbol(sym.libreria, yychar, yyline,yytext());}
cafe {return new Symbol(sym.café, yychar, yyline,yytext());}
...
library {return new Symbol(sym.libreria, yychar, yyline,yytext());}
...
left {return new Symbol(sym.izquiera, yychar, yyline,yytext());}
...
as {return new Symbol(sym.como, yychar, yyline, yytext());}
than {return new Symbol(sym.que, yychar, yyline, yytext());}
to {return new Symbol(sym.a, yychar, yyline, yytext());}
to {return new Symbol(sym.para, yychar, yyline, yytext());}
